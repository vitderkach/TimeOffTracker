...
namespace TOT.Tests {
    ...
    public class ManagerTests {
        ...
        public void Initialize()
        {
            ...
            {
                new ManagerResponse() {Id = 1, ManagerId = 1, Approval = true, VacationRequestId = 10,  VacationRequest = new VacationRequest() { VacationType = TimeOffType.ConfirmedSickLeave }  },
                new ManagerResponse() {Id = 2, ManagerId = 1, Approval = null, VacationRequestId = 5,  VacationRequest = new VacationRequest() { VacationType = TimeOffType.ConfirmedSickLeave }},
                new ManagerResponse() {Id = 3, ManagerId = 2 , Approval = null, VacationRequestId = 11,  VacationRequest = new VacationRequest() { VacationType = TimeOffType.ConfirmedSickLeave }},
                new ManagerResponse() {Id = 4, ManagerId = 3 , Approval = null, VacationRequestId = 12,  VacationRequest = new VacationRequest() { VacationType = TimeOffType.ConfirmedSickLeave }},
            };
